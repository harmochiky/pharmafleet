                          ...
                          <div className="ec-spe-pro-image-outer col-md-6 col-sm-12">
                            <div className="ec-spe-pro-image">
                              <img
                                ...
                                src="https://loopinfosol.in/themeforest/ekka-html-v32/ekka-html/assets/images/product-image/78_1.jpg"
                                alt=""
                              />
                            </div>
                          </div>
                ...
                <div className="ec_ser_inner">
                  <div className="ec-service-image">
                    <svg
                      ...
                      xmlSpace="preserve"
                      src="assets/images/icons/service_4_1.svg"
                      className="svg_img ser_svg"
                      alt=""
                    >
                      <g>
                        <g>
                ...
                <div className="ec_ser_inner">
                  <div className="ec-service-image">
                    <svg
                      ...
                      xmlSpace="preserve"
                      src="assets/images/icons/service_4_2.svg"
                      className="svg_img ser_svg"
                      alt=""
                    >
                      <g>
                ...
                <div className="ec_ser_inner">
                  <div className="ec-service-image">
                    <svg
                      ...
                      xmlSpace="preserve"
                      src="assets/images/icons/service_4_3.svg"
                      className="svg_img ser_svg"
                      alt=""
                    >
                      <g>
                ...
                <div className="ec_ser_inner">
                  <div className="ec-service-image">
                    <svg
                      ...
                      style={{ enableBackground: "new 0 0 469.411 469.411" }}
                      xmlSpace="preserve"
                      src="assets/images/icons/service_4_4.svg"
                      className="svg_img ser_svg"
                      alt=""
                    >
                      <g>
                ...
                <div className="ec_ser_inner">
                  <div className="ec-service-image">
                    <svg
                      ...
                      xmlSpace="preserve"
                      src="assets/images/icons/service_4_5.svg"
                      className="svg_img ser_svg"
                      alt=""
                    >
                      <g>
